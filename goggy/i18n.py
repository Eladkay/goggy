...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "slug_hint": "Optional. Leave blank to derive from the title. Cannot be changed once the post is created.",
        "slug_immutable_hint": "Slugs are immutable — this is the permanent URL for this post.",
        "paste_hint": "Tip: paste images directly with Ctrl/Cmd+V. To resize, add width=\"400\" (or any pixel value) to the inserted <img> tag.",
        "markdown": "Markdown",
        "preview": "Preview",
        ...
        # about
        "about_goggy": "About Goggy",
        "version": "Version",
        "about_blurb": "Goggy is a minimal single-admin Markdown blog.",
        # two-factor auth
    ...
    "he": {
        ...
        "slug_label": "כתובת קצרה (Slug)",
        "slug_placeholder": "ייווצר אוטומטית מהכותרת",
        "slug_hint": "אופציונלי. השאירו ריק כדי ליצור מהכותרת. לא ניתן לשנות לאחר היצירה.",
        "slug_immutable_hint": "כתובות קצרות אינן ניתנות לשינוי — זוהי הכתובת הקבועה של הרשומה.",
        "paste_hint": "טיפ: ניתן להדביק תמונות ישירות עם Ctrl/Cmd+V. לשינוי גודל, הוסיפו width=\"400\" (או ערך פיקסלים אחר) לתגית <img> שמוכנסת.",
        "markdown": "Markdown",
        ...
        "save": "שמירה",
        "saved": "ההגדרות נשמרו.",
        "about_goggy": "אודות Goggy",
        "version": "גרסה",
        "about_blurb": "Goggy הוא בלוג Markdown מינימלי עם מנהל יחיד.",
