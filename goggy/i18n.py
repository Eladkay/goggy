...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "autosave_found": "Unsaved draft found on this device.",
        "autosave_saved": "Draft saved on this device",
    ...
    "he": {
        ...
        "autosave_found": "נמצאה טיוטה שלא נשמרה במכשיר זה.",
        "autosave_saved": "הטיוטה נשמרה במכשיר זה",
        "discard_draft": "התעלם",
